defmodule FiberFinder.FiberLinesController do
  require Logger
  use FiberFinder.Web, :controller
  alias FiberFinder.FiberLinesProvider
  ...
  def show(conn, params) do
    ...
    query = FiberLinesProvider.retrieve(params["longitude"], params["latitude"], params["distance"], params["name"])
    IO.inspect(query)
